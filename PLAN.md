...
- [ ] **T6.2 — أستوديو المورد، ديسكتوب** (المرجع:
  ...
  - بعد T6.1: الملف الحالي هو `ReelsStudioPageDesktop.tsx` (نقل حرفي
    مؤقت لشبكة البلاطات القديمة) — يُستبدل هنا بالمشغّل الحقيقي
    300px + لوحة الأداء + قائمة اللقطات، مستفيداً من
    `useReelsStudioData.ts` المشترك الجاهز من T6.1.
  - **T6.2.1** (اكتُشفت في T1.5): استبدل `ReelTile` المحلي داخل
    `ReelsStudioPageDesktop.tsx` بالمكوّن المشترك `components/ui/ReelTile.tsx`
