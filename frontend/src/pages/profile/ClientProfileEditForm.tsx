  ...
  return (
    <div>
      ...
      <input
        ...
        className="w-full rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-900 transition-colors duration-150 focus:border-importer-400 focus:bg-white focus:outline-none"
      />
    </div>
  );
}
