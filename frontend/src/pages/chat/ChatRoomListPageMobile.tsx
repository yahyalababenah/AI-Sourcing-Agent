...
// Room list, mobile (T8.6). Same shared hook as ChatRoomListPageDesktop —
// only the container width differs (no chat-*.html reference exists for
// Phase 8). TopBar/BottomNav/Drawer come from the role's own layout.
export function ChatRoomListPageMobile() {
          ...
          {rooms.map((room) => {
            ...
            return (
              <button
                ...
                className="w-full rounded-xl border border-slate-200 bg-white p-4 text-start shadow-sm transition-all duration-150 hover:border-brand-300 hover:shadow-md active:scale-[0.99]"
              >
