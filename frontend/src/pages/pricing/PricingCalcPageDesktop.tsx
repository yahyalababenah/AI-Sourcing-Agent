...
// Desktop layout matches pricing-calculator-desktop.html: shipment/products
// form on the wide (right, RTL-first) column, sticky result card on the
// narrow (left) column. The RFQ-driven multi-product flow itself is real
// production logic (see usePricingCalculator) — only the visual language
// changed to match the design system (LineRow, slate figures, green total).
export function PricingCalcPageDesktop() {
  const {
    selectedRfqId,
    targetCurrency,
    setTargetCurrency,
    ...
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_380px]">
        <div className="space-y-6">
          ...
          {selectedRfqId && (
            <div className="card p-6">
              <h2 className="mb-4 text-lg font-semibold text-slate-900">تعديل المنتجات</h2>
