...
// Shipment tracking timeline, desktop (T8.7). Same shared hook/components
// as OrderTrackingPageMobile — a wider two-column layout (timeline on the
// wide side, order summary + agent controls on the narrow sticky side)
// instead of one stacked column. No orders-tracking-*.html reference
// exists for Phase 8 (same gap as T8.6's chat pages).
export function OrderTrackingPageDesktop() {
  const {
    id,
    navigate,
    quote,
