...
export type OrderStatus = "pending" | "under_review" | "negotiating" | "in_progress" | "completed" | "rejected";
...
// "rejected" added for T8.3 (quote statuses) — no prior caller needed it.
