  ...
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col justify-end bg-slate-900/50 lg:hidden" role="presentation">
      <div
        ...
        className="overscroll-contain rounded-t-2xl bg-white p-6 pb-[calc(2rem+env(safe-area-inset-bottom))] text-center shadow-xl transition-all duration-200 motion-reduce:transition-none"
      >
